  ...
  const onSubmitEmail = async () => {
    ...
    for (i = 0; i <= nickname.length; i++) {
      if (checkNum.test(nickname[i]) || checkEng.test(nickname[i]))
        nicknameLength++;
      else if (checkKor.test(nickname[i])) nicknameLength = nicknameLength + 2;
        ...
        <S.mainContainer>
          ...
          <S.mainSection>
            <S.mainContainer>
              ...
              <S.rightAlignment>
                <S.errorMessage style={{ visibility: emailStyle }}>
                  이미 존재하는 이메일입니다.
                </S.errorMessage>
              </S.rightAlignment>
              <S.mainSection>
              ...
              <S.rightAlignment>
                <S.errorMessage style={{ visibility: nicknameStyle }}>
                  한글 10자, 영문 20자 이내로 설정할 수 있습니다.
                </S.errorMessage>
              </S.rightAlignment>
              <S.mainSection>
                <S.input
              ...
              <S.rightAlignment>
                <S.errorMessage style={{ visibility: passwordStyle }}>
                  비밀번호는 8자 이상이어야 합니다.
                </S.errorMessage>
              </S.rightAlignment>
              <S.mainSection>
                <S.signUpButton
                  ...
                  disabled={!(email && nickname && age && password)}
                >
                  다음으로{" "}
                </S.signUpButton>
              </S.mainSection>
